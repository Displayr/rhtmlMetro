...
class Box {
  ...
  draw () {
    ...
    let box = d3.select(this.rootElement)
      ...
      .style('display', 'table')
      .style('width', this.config.border_width == 0 ? this.width + 'pt' : (this.width-this.config.border_width*2) + 'pt')
      .style('height', this.config.border_width == 0 ? this.height + 'pt' : (this.height-this.config.border_width*2) + 'pt')
      .style('background-color', this.config.background_color)
      .style('border-style', this.config.border_style)
      .style('border-width', this.config.border_width + 'pt')
